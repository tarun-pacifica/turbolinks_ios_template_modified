...
class CustomTabbarViewController: UITabBarController {
    override func viewDidLoad() {
        ...
        tab1.tabBarItem = UITabBarItem.init(title: "", image: UIImage(named: "home")?.withRenderingMode(.alwaysOriginal), selectedImage: UIImage(named: "home_active")?.withRenderingMode(.alwaysOriginal))
        ...
        tab2.tabBarItem = UITabBarItem.init(title: "", image: UIImage(named: "google")?.withRenderingMode(.alwaysOriginal), selectedImage: UIImage(named: "google_active")?.withRenderingMode(.alwaysOriginal))
